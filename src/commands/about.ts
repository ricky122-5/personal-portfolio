...
const createAbout = () : string[] => {
  ...
  about.push("I'm currently interning at the Georgia Tech Research Institute working on Javelin, a govt. personnel management application.")
  about.push("I love to work in deep learning, high-performance computing, financial applications, and full-stack dev!")
  about.push("<br>");
